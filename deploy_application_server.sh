...
echo "Type the host name of this application server (ex: video1, video2, etc.) followed by [ENTER]:"
...
echo "Type the host name of the database server (ex: database) followed by [ENTER]:"
...
echo "Type the username of the database SQL account to connect the application server to (ex: root) followed by [ENTER]:"
...
echo "Type the password of the database account to connect the application server to (ex: cdc) followed by [ENTER]:"
